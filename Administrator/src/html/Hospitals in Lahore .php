    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <!--  Row 1 -->
         ...
         <h1>Add Hospitals in Lahore         </h1><br><br>
...
<?php
      ...
      while($result = mysqli_fetch_assoc($data)) {
        ...
        <td>
        <a name='delete' href='delete-HospitalsinLahore.php?id=$result[id]' class='btn btn-success'>Delete</a>
...
include('connection.php');
   ...
   if(isset($_POST['submit'])){
    ...
    $query = "insert into hospital_lahore(imag,name,address)VALUES('$img_name','$name','$address')";
